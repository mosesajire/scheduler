...
<head>
    ...
    <title>{{ config('app.name', 'Scheduler') }} - @yield('title')</title>
...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item"><a href="/activities" class="nav-link">Your Activities</a></li>
                            <li class="nav-item"><a href="/activities/create" class="nav-link">Add New Activity</a></li>
        ...
        <footer class="card-footer text-center">
            <p>Thank you for using Scheduler</p>
        </footer>
    </div>
</body>
</html>
